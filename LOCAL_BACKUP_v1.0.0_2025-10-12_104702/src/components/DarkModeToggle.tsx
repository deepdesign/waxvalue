...
export function DarkModeToggle() {
  ...
  return (
    <div className="flex w-full bg-gray-100 dark:bg-gray-800 rounded-lg p-1 select-none">
      <button
        onClick={() => setTheme('light')}
        className={`flex-1 flex items-center justify-center py-2 rounded-md transition-all duration-200 select-none ${
          theme === 'light'
